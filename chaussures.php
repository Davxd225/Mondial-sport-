...
$produits = getProduitsByCategory('Chaussures');
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>Chaussures | Mondial Sport</title>
    ...
    <section class="category-hero">
        ...
        <div class="category-hero-content container">
            ...
            <p class="category-description">
                D̩couvrez notre s̩lection de chaussures sport premium disponibles dans nos boutiques Mondial Sport.
            </p>
